...
set(jetson_cross "$ENV{HOME}/opt/jetson_cross")

__add_cache_path(CUDAToolkit_ROOT "${jetson_cross}/usr/local/cuda-10.2/bin")
__add_cache_path(TRT_SO_DIR "${jetson_cross}/usr/lib/aarch64-linux-gnu")
__add_cache_path(PSDK_DIR "${jetson_cross}/usr")
